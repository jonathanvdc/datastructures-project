...
class Quicksort(IListSorter):
    """ Defines a quicksort implementation for IListSorter<T>. Elements are sorted in ascending order using quicksort based on input from an IComparer<T> which is obtained via a constructor parameter. """
